...
class FashionIQDataset(Dataset):
    ...
    def __init__(self, dataset: str, split: str, dress_types: List[str], mode: str, preprocess: callable):
        """
        :param split: dataset split, should be in ['test', 'train', 'val']
        ...
        if dataset not in ['fashioniq', 'css']:
            raise ValueError("Dataset should be in ['fashioniq', 'css']")
        ...
        for dress_type in dress_types:
            if dataset == 'fashioniq':
                ...
                with open(base_path / 'css_dataset' / 'captions' / f'cap.{dress_type}.{split}.json') as f:
                    self.triplets.extend(json.load(f))
        ...
        for dress_type in dress_types:
            if dataset == 'fashioniq':
                ...
                with open(base_path / 'css_dataset' / 'image_splits' / f'split.{dress_type}.{split}.json') as f:
                    self.image_names.extend(json.load(f))

        if dataset == 'fashioniq':
            print(f"FashionIQ {split} - {dress_types} dataset in {mode} mode initialized")
        elif dataset == 'css':
            print(f"CSS {split} - {dress_types} dataset in {mode} mode initialized")
        ...
        try:
            if self.mode == 'relative':
                ...
                if self.split == 'train':
                    ...
                    elif self.dataset == 'css':
                        reference_image_path = base_path / 'css_dataset' / 'images' / f"{reference_name}.png"
                    ...
                    if self.dataset == 'fashioniq':
                        ...
                        target_image_path = base_path / 'css_dataset' / 'images' / f"{target_name}.png"
                ...
                if self.dataset == 'fashioniq':
                    ...
                    image_path = base_path / 'css_dataset' / 'images' / f"{image_name}.png"
